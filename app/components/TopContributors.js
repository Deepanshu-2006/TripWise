...
export default function TopContributors() {
  ...
  return (
    <>
      ...
      `}} />
      <div className="sticky top-25 h-fit w-full">
        <div className="relative bg-stone-900/95 backdrop-blur-2xl rounded-4xl p-6 md:p-8 shadow-[0_20px_40px_rgba(0,0,0,0.4)] border border-stone-700/50 flex flex-col overflow-hidden group/board">
          
          {/* Subtle top edge glow */}
          <div className="absolute top-0 left-0 right-0 h-px bg-linear-to-r from-transparent via-[#F4703C]/30 to-transparent opacity-50" />

          {/* Header */}
          <div className="flex items-center gap-3 mb-6 relative z-10">
            <div className="w-10 h-10 rounded-full bg-linear-to-br from-[#F4703C]/20 to-transparent flex items-center justify-center border border-[#F4703C]/30 group-hover/board:border-[#F4703C]/60 group-hover/board:shadow-[0_0_20px_rgba(244,112,60,0.2)] transition-all duration-500">
              ...
              <div key={user.id} className="relative group/row shrink-0 w-[280px] lg:w-auto snap-start">
                ...
                <div className="relative flex items-center justify-between py-4 px-3 rounded-2xl transition-all duration-300 hover:bg-stone-800/40 hover:scale-[1.02] cursor-pointer z-10 overflow-hidden bg-stone-800/20 lg:bg-transparent border border-stone-700/50 lg:border-transparent">
                  ...
                  <div className="flex items-center gap-4 relative z-10">
                    ...
                    <div className={`w-9 h-9 rounded-full flex items-center justify-center shrink-0 transition-transform duration-500 group-hover/row:scale-110 group-hover/row:rotate-360 relative ${
                      index === 0 ? 'bg-linear-to-br from-[#FFD700] via-[#FFA500] to-[#D97706] shadow-[inset_0_2px_5px_rgba(255,255,255,0.7),inset_0_-2px_5px_rgba(0,0,0,0.2),0_0_20px_rgba(245,158,11,0.4)] text-[#431407]' :
                      index === 1 ? 'bg-linear-to-br from-[#F8FAFC] via-[#CBD5E1] to-[#94A3B8] shadow-[inset_0_2px_5px_rgba(255,255,255,0.9),inset_0_-2px_5px_rgba(0,0,0,0.2),0_0_20px_rgba(148,163,184,0.3)] text-[#0F172A]' :
                      index === 2 ? 'bg-linear-to-br from-[#FDBA74] via-[#F97316] to-[#9A3412] shadow-[inset_0_2px_5px_rgba(255,255,255,0.5),inset_0_-2px_5px_rgba(0,0,0,0.3),0_0_20px_rgba(234,88,12,0.3)] text-[#FFF7ED]' :
                      ...
                      {index < 3 && (
                         <div className="absolute inset-0 rounded-full bg-linear-to-tr from-white/0 via-white/40 to-white/0 opacity-0 group-hover/row:opacity-100 transition-opacity duration-300" />
                      )}
                    </div>
                    ...
                    <div className="relative">
                      ...
                      <div className="absolute -inset-0.75 rounded-full bg-linear-to-tr from-[#F4703C] to-[#E25C27] opacity-0 group-hover/row:opacity-100 transition-opacity duration-500 blur-[2px]" />
                      <div className="absolute inset-[-1.5px] rounded-full bg-linear-to-tr from-[#F4703C] to-[#E25C27] opacity-0 group-hover/row:opacity-100 transition-opacity duration-500" />
                    ...
                    <div className="flex flex-col items-start gap-1">
                      ...
                      <span className={`px-2.5 py-0.5 rounded-full text-[9px] font-mono font-bold uppercase tracking-widest transition-colors duration-300 shadow-sm ${
          ...
          >
            <span className="absolute inset-0 w-full h-full bg-linear-to-r from-[#F4703C] to-[#E25C27] opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-out" />
