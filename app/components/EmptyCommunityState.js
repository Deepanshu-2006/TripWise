...
export default function EmptyCommunityState() {
  return (
    <div className="relative w-full overflow-hidden flex flex-col items-center justify-center bg-gradient-to-br from-stone-50 to-stone-100/50 rounded-[3rem] border border-stone-200/60 p-16 md:p-24 text-center group hover:bg-white transition-all duration-700 shadow-sm hover:shadow-xl hover:shadow-[#F4703C]/10">
      
      {/* Decorative Grid Background */}
      <div className="absolute inset-0 bg-[linear-gradient(rgba(0,0,0,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(0,0,0,0.03)_1px,transparent_1px)] bg-[size:40px_40px] [mask-image:radial-gradient(ellipse_60%_60%_at_50%_50%,#000_20%,transparent_100%)] opacity-0 group-hover:opacity-100 transition-opacity duration-1000" />
      
      {/* Subtle Background Glows */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-gradient-to-tr from-[#F4703C]/0 via-[#F4703C]/5 to-transparent rounded-full blur-[80px] group-hover:scale-110 transition-all duration-1000 ease-out pointer-events-none" />
      ...
      <div className="relative z-10 w-28 h-28 bg-white/80 backdrop-blur-sm rounded-full flex items-center justify-center mb-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] group-hover:-translate-y-2 group-hover:shadow-[0_20px_40px_rgba(244,112,60,0.15)] transition-all duration-500 border border-white">
        ...
        {/* Icon */}
        <div className="relative z-10 w-14 h-14 bg-gradient-to-br from-stone-100 to-stone-200 rounded-full flex items-center justify-center group-hover:from-[#F4703C]/10 group-hover:to-[#F4703C]/20 transition-colors duration-500">
