 ...
 */
export const calculateDailyPace = (expenses = [], totalDays = 3, estBudget = 1450) => {
  ...
  const actualPaceUSD = totalSpentUSD / days;
  const targetPaceUSD = (parseFloat(estBudget) || 1450) / days;
  const status = actualPaceUSD > targetPaceUSD ? 'over' : 'under';
