export const DESTINATIONS = [
  {
    ...
    duration: '10–14 days',
    prompt: '14 days in Argentina: Patagonia hiking, Buenos Aires tango, Mendoza wine tasting',
  ...
  },
  {
    ...
    rating: 4.6,
    reviews: 2104,
    vibes: ['history', 'foodie'],
    budget: ['economy'],
    tagline: 'A bustling maze of ancient empires',
    duration: '3–5 days',
    prompt: '4 days in New Delhi: Red Fort, street food tours, Lotus Temple & bustling bazaars',
    gradient: 'from-orange-900/70 via-red-800/50 to-transparent',
    imageUrl: 'https://plus.unsplash.com/premium_photo-1697730429201-381b71f61427?w=800&auto=format&fit=crop&q=80',
    emoji: '🇮🇳',
    bgColor: '#A87A5B',
  },
  {
    ...
    duration: '7–10 days',
    prompt: '8 days in Portugal: Algarve beaches, Lisbon pastries, Sintra castles & Porto wine',
    gradient: 'from-amber-900/70 via-yellow-800/50 to-transparent',
  ...
  },
  {
    ...
    duration: '3–5 days',
    prompt: '4 days in Denmark: Copenhagen design tours, Tivoli Gardens, Nyhavn & modern Nordic food',
  ...
  },
  {
    ...
    duration: '7–10 days',
    prompt: '9 days in Scotland: Highlands roadtrip, Isle of Skye, Edinburgh Castle & loch side cabins',
